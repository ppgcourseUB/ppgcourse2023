...
srun --ntasks 1 --exclusive --mem-per-cpu=1GB slim -t -m -d "Ne=500" -d "L=500000" -d "Neb=500" -d "mut_rate=1e-6" -d "rec_rate=1e-4" -d "ngenes=100" -d "rate_ben=0.005" -d "rate_del=0" -d "s_backg_ben=0.005" -d "s_backg_del=0" -d "nsweeps=0" -d "freq_sel_init=0.05" -d "freq_sel_end=0.95" -d "s_beneficial=0.1" -d "ind_sample_size=25" -d "out_sample_size=1" -d "file_output1='./02_slim_SFS_PSL.txt'" ./slim_template.slim&
srun --ntasks 1 --exclusive --mem-per-cpu=1GB slim -t -m -d "Ne=500" -d "L=500000" -d "Neb=200" -d "mut_rate=1e-6" -d "rec_rate=1e-4" -d "ngenes=100" -d "rate_ben=0.05" -d "rate_del=8" -d "s_backg_ben=0.005" -d "s_backg_del=-1.0" -d "nsweeps=0" -d "freq_sel_init=0.05" -d "freq_sel_end=0.95" -d "s_beneficial=0.1" -d "ind_sample_size=25" -d "out_sample_size=1" -d "file_output1='./03_slim_SFS_BGS_PSL_RED.txt'" ./slim_template.slim&
srun --ntasks 1 --exclusive --mem-per-cpu=1GB slim -t -m -d "Ne=500" -d "L=500000" -d "Neb=2500" -d "mut_rate=1e-6" -d "rec_rate=1e-4" -d "ngenes=100" -d "rate_ben=0.05" -d "rate_del=8" -d "s_backg_ben=0.005" -d "s_backg_del=-1.0" -d "nsweeps=0" -d "freq_sel_init=0.05" -d "freq_sel_end=0.95" -d "s_beneficial=0.1" -d "ind_sample_size=25" -d "out_sample_size=1" -d "file_output1='./04_slim_SFS_BGS_PSL_EXP.txt'" ./slim_template.slim&
