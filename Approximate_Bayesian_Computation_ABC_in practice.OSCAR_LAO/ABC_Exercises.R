...
# another that perfectly correlate. In fact, the frequency estimated in a sample is a SUFFICIENT STATISTIC of the frequency of the model
...
# If you want to implement these approaches for your problem,
# please contact us: oscar.lao@ibe.upf-csic.es
