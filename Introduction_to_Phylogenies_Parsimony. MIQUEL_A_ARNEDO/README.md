...
TIP:
TNT allows you to write small scripts to automate certain tasks. As an example, there is a script that calculates Partition Bremer Support (pbsup.run) written by Carlos Peña and available at https://github.com/carp420/pbsup.run.
